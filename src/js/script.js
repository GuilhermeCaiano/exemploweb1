...
var exemplo="ola-dev"
console.log(exemplo); //typeof verifica tipo de variavel colocar por exemplo no atual (typeof exemplo)
...
// = atribuição
// == comparação
// === calor e tipo(estritamente igual)
// && = E (todas condições tem que ser verdadeiras)
// || = ou (umas das condição tem que ser verdadeira)
